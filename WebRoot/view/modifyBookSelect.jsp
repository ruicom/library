...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="modifyBookSelectSolver" method="post">
        <h2 class="form-signin-heading">查询需要更改的书籍</h2>
        ...
        <input class="btn btn-large btn-primary" type="submit" value="查询"><br><br>
       	 <a href="modifyBook" class="btn btn-large btn-primary">直接修改</a>
