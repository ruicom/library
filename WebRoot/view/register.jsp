...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="registerSolver" method="post">
   ...
   重新输入密码 :<input type="password" class="input-block-level" name="repassword">
   	性别:<label class="checkbox inline">
		...
		<label class="checkbox inline">
   		...
   		学号:<input type="text" class="input-block-level" name="number">	
        <label class="checkbox">
         
        </label>
        <input class="btn btn-large btn-primary" type="submit" value="注册"><br><br>
